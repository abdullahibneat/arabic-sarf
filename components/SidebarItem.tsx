  ...
  return (
    <Link
      ...
      className={cx(
        ...
        isActive &&
          'border-zinc-300 bg-white dark:border-neutral-600 dark:bg-neutral-600',
        !isActive &&
          'hover:border-zinc-300 hover:bg-zinc-100 active:bg-zinc-200 dark:hover:border-neutral-600 dark:hover:bg-neutral-700 dark:active:bg-neutral-600',
      )}
